...
// Complete users data from the user's request
$usersData = [
...
// Generate SQL
$sql = "INSERT INTO `users` (`id`, `name`, `rfc`, `curp`, `direction`, `position`, `sex`, `lvl`, `tipo`, `status`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `remember_token`, `current_team_id`, `profile_photo_path`, `created_at`, `updated_at`) VALUES\n";
...
// Write to file
file_put_contents('database/seeders/users_data.sql', $sql);

echo "Complete SQL file created with " . count($usersData) . " users!\n";
